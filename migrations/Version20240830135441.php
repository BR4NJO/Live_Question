 ...
 */
final class Version20240830135441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer ADD question_id INT NOT NULL, ADD user_id INT NOT NULL, ADD content LONGTEXT NOT NULL, ADD date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer DROP question_id, DROP user_id, DROP content, DROP date');
    }
}
